            ...
            client.snekfetch.get(compare).then((r) => {
                ...
                client.snekfetch.get(map).then((r) => {
                    ...
                    client.request('http://osu.ppy.sh/osu/' + lastMapID, (error, response, cBody) => {
                        //im too lazy to document all this cause its the same as the other things
                        let rank1;
                        ...
                        //ye i did this in beatconnect.js already just look there
                        let field1 = {
                            "name": `1. \`${bodyc[0].date}\``,
